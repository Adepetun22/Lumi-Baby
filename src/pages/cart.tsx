          ...
          <div>
            ...
            <div className="space-y-5">
              {cartItems.map((item, idx) => (
                <div key={item.id} className="grid grid-cols-[80px_1.8fr_1fr_1fr_1fr_40px] lg:grid-cols-[80px_1.8fr_1fr_1fr_1fr_40px] grid-rows-[auto_auto] lg:grid-rows-1 gap-3 items-start py-5.5 border-b border-clay/5 last:border-b-0">
                  {/* Image */}
